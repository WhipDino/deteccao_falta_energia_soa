...
public class ClimaConsultaService {
    ...
    public ClimaInfo consultarClima(String cidade) {
        try {
            ...
            // Em uma aplicação real, poderia usar um logger mais robusto (SLF4j, Logback, etc.)
            // Thread.currentThread().interrupt(); // Re-interrupt if InterruptedException occurred
